...
>(({ className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={mergeStyles(toastVariants({ variant }), className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={mergeStyles("text-sm font-semibold [&+div]:text-xs", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={mergeStyles("text-sm opacity-90", className)}
    {...props}
  />
))
